...
export const fakeColumns = [
  {
    ...
    sortable: true,
    cellRenderer: (data) => (
      <Text variant={TextVariantsEnum.Text_md}>{data.id}</Text>
    ),
  },
  {
    id: 'userId',
    ...
    sortable: true,
    cellRenderer: (data) => (
      <Text variant={TextVariantsEnum.Text_md}>{data.userId}</Text>
    ),
  },
  {
    id: 'title',
    ...
    sortable: true,
    cellRenderer: (data) => (
      <Text variant={TextVariantsEnum.Text_md}>{data.title}</Text>
    ),
  },
  {
    id: 'body',
    name: 'Text',
    cellRenderer: (data) => (
      <Text variant={TextVariantsEnum.Text_md}>{data.body}</Text>
    ),
  },
];
